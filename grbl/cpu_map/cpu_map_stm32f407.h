...
/* Grbl officially supports the Arduino Uno, but the other supplied pin mappings are
   ...
   pin mapping settings file for the STM32F407.  */
...
extern uint8_t dummy_reg;

#define GRBL_PLATFORM "STM32F407"
...
#define PROBE_PIN       GPIOC->IDR
#define PROBE_PORT      (dummy_reg)
#define PROBE_BIT       3  // PC3
